...
public class MainActivity extends AppCompatActivity {
    ...
    String titulo []={"Avatar","Como eu era antes de você","Os croods","Invasão Zumbi"};
    ...
    String acesso[]={"4.5","5.0","3.5"};
    int filmes[]={R.drawable.avatar,R.drawable.antes,R.drawable.croods};
